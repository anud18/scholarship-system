...
describe.skip("FileUpload Component - Simple Tests", () => {
  ...
  it("should handle different locales", () => {
    ...
    const { rerender } = render(
      <FileUpload onFilesChange={mockOnFilesChange} locale="zh" />
    );
  ...
  it("should handle maxFiles prop", () => {
    ...
    render(<FileUpload onFilesChange={mockOnFilesChange} maxFiles={3} />);
  ...
  it("should handle fileType prop", () => {
    ...
    render(
      <FileUpload onFilesChange={mockOnFilesChange} fileType="transcript" />
    );
  ...
  it("should generate unique input IDs", () => {
    ...
    const { unmount } = render(
      <FileUpload onFilesChange={mockOnFilesChange} fileType="test" />
    );
