...
test.describe("管理員手動分發後申請轉為核准 | Admin manual distribution → application approved", { tag: [MODE.api, ROLE.student, ROLE.professor, ROLE.college, ROLE.admin, FEATURE.ranking, FEATURE.distribution] }, () => {
