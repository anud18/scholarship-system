...
test.describe("admin revoke dialog — confirm disabled until reason filled", { tag: [MODE.browser, ROLE.admin, FEATURE.revokeSuspend, FEATURE.distribution] }, () => {
...
test.describe("locked roster dialog — revoked student panel + item removal", { tag: [MODE.api, ROLE.admin, FEATURE.revokeSuspend, FEATURE.roster, FEATURE.notification, FEATURE.history] }, () => {
  let runState: RunState;
