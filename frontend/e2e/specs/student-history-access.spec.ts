...
test.describe("College student history lookup", { tag: [MODE.browser, ROLE.college, FEATURE.history] }, () => {
...
test.describe("Student total received months", { tag: [MODE.browser, ROLE.student, FEATURE.history] }, () => {
