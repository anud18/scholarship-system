...
test.describe("管理員預覽對話框顯示已上傳 PDF | Admin preview dialog renders an uploaded PDF (UI layer)", { tag: [MODE.browser, ROLE.admin, ROLE.student, FEATURE.upload, FEATURE.preview] }, () => {
...
test.describe("pdfjs worker 版本一致性 | pdfjs worker version contract", { tag: [MODE.api, FEATURE.preview] }, () => {
