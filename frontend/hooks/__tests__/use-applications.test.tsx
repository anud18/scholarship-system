...
const mockGetMyApplications = jest
  .fn()
  .mockResolvedValue({ success: true, data: [] });
const mockCreateApplication = jest
  .fn()
  .mockResolvedValue({ success: true, data: {} });
const mockSubmitApplication = jest
  .fn()
  .mockResolvedValue({ success: true, data: {} });
const mockWithdrawApplication = jest
  .fn()
  .mockResolvedValue({ success: true, data: {} });
const mockUpdateApplication = jest
  .fn()
  .mockResolvedValue({ success: true, data: {} });
const mockUploadDocument = jest
  .fn()
  .mockResolvedValue({ success: true, data: {} });
const mockSaveApplicationDraft = jest
  .fn()
  .mockResolvedValue({ success: true, data: {} });
const mockDeleteApplication = jest
  .fn()
  .mockResolvedValue({ success: true, data: {} });
...
jest.mock("@/lib/api", () => ({
  apiClient: {
    ...
    applications: {
      ...
      saveApplicationDraft: (...args: any[]) =>
        mockSaveApplicationDraft(...args),
...
describe.skip("useApplications Hook", () => {
  ...
  describe("fetchApplications", () => {
    ...
    it("should not fetch when user is not authenticated", async () => {
      ...
      expect(
        mockApiClient.applications.getMyApplications
