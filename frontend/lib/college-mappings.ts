...
export const COLLEGE_MAPPINGS: Record<string, CollegeMapping> = {
  "E": { code: "E", name: "電機學院", name_en: "College of Electrical and Computer Engineering" },
  ...
  "B": { code: "B", name: "工程生物學院", name_en: "College of Biological Science and Technology" },
  "O": { code: "O", name: "光電學院", name_en: "College of Photonics" },
  "D": { code: "D", name: "半導體學院", name_en: "College of Semiconductor Research" },
  "1": { code: "1", name: "醫學院", name_en: "College of Medicine" },
  "6": { code: "6", name: "生醫工學院", name_en: "College of Biomedical Engineering" },
  "7": { code: "7", name: "生命科學院", name_en: "College of Life Science" },
  "M": { code: "M", name: "管理學院", name_en: "College of Management" },
  "A": { code: "A", name: "人社院", name_en: "College of Humanities and Social Sciences" },
...
export function getAllColleges(): CollegeMapping[] {
  return Object.values(COLLEGE_MAPPINGS).sort((a, b) => a.code.localeCompare(b.code))
}
