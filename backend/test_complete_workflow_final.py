...
from app.api.v1.endpoints.professor import get_professor_applications, submit_professor_review, get_professor_review, get_application_sub_types
    ...
    async with AsyncSessionLocal() as db:
        ...
        try:
            ...
            for i, st in enumerate(sub_types):
                review_items.append(ProfessorReviewItemCreate(
