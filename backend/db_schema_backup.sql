...
--
-- Name: rosterauditaction; Type: TYPE; Schema: public; Owner: scholarship_user
--

CREATE TYPE public.rosterauditaction AS ENUM (
    'create',
    'update',
    'delete',
    'lock',
...
ALTER TYPE public.rosterauditaction OWNER TO scholarship_user;

--
-- Name: rosterauditlevel; Type: TYPE; Schema: public; Owner: scholarship_user
--

CREATE TYPE public.rosterauditlevel AS ENUM (
    'info',
    'warning',
    'error',
    'critical'
...
ALTER TYPE public.rosterauditlevel OWNER TO scholarship_user;

--
-- Name: rostercycle; Type: TYPE; Schema: public; Owner: scholarship_user
--
...
ALTER TYPE public.rostercycle OWNER TO scholarship_user;

--
-- Name: rosterstatus; Type: TYPE; Schema: public; Owner: scholarship_user
--

CREATE TYPE public.rosterstatus AS ENUM (
    'draft',
    'processing',
    'completed',
    'locked',
...
ALTER TYPE public.rosterstatus OWNER TO scholarship_user;

--
-- Name: rostertriggertype; Type: TYPE; Schema: public; Owner: scholarship_user
--

CREATE TYPE public.rostertriggertype AS ENUM (
    'manual',
    'scheduled',
    'dry_run'
);
...
ALTER TYPE public.rostertriggertype OWNER TO scholarship_user;

--
-- Name: schedulestatus; Type: TYPE; Schema: public; Owner: scholarship_user
--
...
ALTER TYPE public.schedulestatus OWNER TO scholarship_user;
...
--
-- Name: studentverificationstatus; Type: TYPE; Schema: public; Owner: scholarship_user
--

CREATE TYPE public.studentverificationstatus AS ENUM (
    'verified',
    'graduated',
    'suspended',
    'withdrawn',
...
ALTER TYPE public.studentverificationstatus OWNER TO scholarship_user;
...
--
-- Name: subtypeselectionmode_new; Type: TYPE; Schema: public; Owner: scholarship_user
--

CREATE TYPE public.subtypeselectionmode_new AS ENUM (
    'single',
    'multiple',
    'hierarchical'
);
...
ALTER TYPE public.subtypeselectionmode_new OWNER TO scholarship_user;
...
--
-- Name: userrole_new; Type: TYPE; Schema: public; Owner: scholarship_user
--

CREATE TYPE public.userrole_new AS ENUM (
    'student',
    'professor',
    'college',
    'admin',
...
ALTER TYPE public.userrole_new OWNER TO scholarship_user;
...
--
-- Name: email_history; Type: TABLE; Schema: public; Owner: scholarship_user
--
...
CREATE TABLE public.email_history (
    ...
    email_category public.emailcategory,
    application_id integer,
    scholarship_type_id integer,
    sent_by_user_id integer,
    sent_by_system boolean NOT NULL,
...
ALTER TABLE public.email_history OWNER TO scholarship_user;

--
-- Name: email_history_id_seq; Type: SEQUENCE; Schema: public; Owner: scholarship_user
--
...
ALTER TABLE public.email_history_id_seq OWNER TO scholarship_user;

--
-- Name: email_history_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: scholarship_user
--
...
--
-- Name: payment_roster_items; Type: TABLE; Schema: public; Owner: scholarship_user
--

CREATE TABLE public.payment_roster_items (
    id integer NOT NULL,
    roster_id integer NOT NULL,
    application_id integer NOT NULL,
    student_id_number character varying(20) NOT NULL,
    ...
    scholarship_subtype character varying(50),
    verification_status public.studentverificationstatus NOT NULL,
    verification_message character varying(500),
    verification_at timestamp with time zone,
    verification_snapshot json,
    is_included boolean NOT NULL,
    exclusion_reason character varying(500),
    excel_row_data json,
    excel_remarks text,
    nationality_code character varying(2),
    residence_days_over_183 character varying(2),
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    rule_validation_result json,
    failed_rules json,
    warning_rules json
);


ALTER TABLE public.payment_roster_items OWNER TO scholarship_user;

--
-- Name: payment_roster_items_id_seq; Type: SEQUENCE; Schema: public; Owner: scholarship_user
--

CREATE SEQUENCE public.payment_roster_items_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.payment_roster_items_id_seq OWNER TO scholarship_user;

--
-- Name: payment_roster_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: scholarship_user
--

ALTER SEQUENCE public.payment_roster_items_id_seq OWNED BY public.payment_roster_items.id;


--
-- Name: payment_rosters; Type: TABLE; Schema: public; Owner: scholarship_user
--

CREATE TABLE public.payment_rosters (
    id integer NOT NULL,
    roster_code character varying(50) NOT NULL,
    scholarship_configuration_id integer NOT NULL,
    period_label character varying(20) NOT NULL,
    academic_year integer NOT NULL,
    roster_cycle public.rostercycle NOT NULL,
    status public.rosterstatus NOT NULL,
    trigger_type public.rostertriggertype NOT NULL,
    ...
    excel_file_path character varying(500),
    excel_file_size integer,
    excel_file_hash character varying(64),
    student_verification_enabled boolean,
    verification_api_failures integer,
    notes text,
    processing_log json,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now()
...
ALTER TABLE public.payment_rosters OWNER TO scholarship_user;

--
-- Name: payment_rosters_id_seq; Type: SEQUENCE; Schema: public; Owner: scholarship_user
--

CREATE SEQUENCE public.payment_rosters_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.payment_rosters_id_seq OWNER TO scholarship_user;

--
-- Name: payment_rosters_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: scholarship_user
--

ALTER SEQUENCE public.payment_rosters_id_seq OWNED BY public.payment_rosters.id;
...
--
-- Name: roster_audit_logs; Type: TABLE; Schema: public; Owner: scholarship_user
--

CREATE TABLE public.roster_audit_logs (
    id integer NOT NULL,
    roster_id integer NOT NULL,
    action public.rosterauditaction NOT NULL,
    level public.rosterauditlevel NOT NULL,
    user_id integer,
...
ALTER TABLE public.roster_audit_logs OWNER TO scholarship_user;

--
-- Name: roster_audit_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: scholarship_user
--

CREATE SEQUENCE public.roster_audit_logs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.roster_audit_logs_id_seq OWNER TO scholarship_user;

--
-- Name: roster_audit_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: scholarship_user
--

ALTER SEQUENCE public.roster_audit_logs_id_seq OWNED BY public.roster_audit_logs.id;


--
-- Name: roster_schedules; Type: TABLE; Schema: public; Owner: scholarship_user
--

CREATE TABLE public.roster_schedules (
    id integer NOT NULL,
    scholarship_configuration_id integer NOT NULL,
    ...
    notify_on_success json,
    notify_on_failure json,
    notification_emails json,
    student_verification_enabled json,
    auto_lock_after_completion json,
    ...
    last_run_roster_id integer,
    next_run_at timestamp with time zone
);


ALTER TABLE public.roster_schedules OWNER TO scholarship_user;

--
-- Name: roster_schedules_id_seq; Type: SEQUENCE; Schema: public; Owner: scholarship_user
--

CREATE SEQUENCE public.roster_schedules_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.roster_schedules_id_seq OWNER TO scholarship_user;

--
-- Name: roster_schedules_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: scholarship_user
--

ALTER SEQUENCE public.roster_schedules_id_seq OWNED BY public.roster_schedules.id;


--
-- Name: scheduled_emails; Type: TABLE; Schema: public; Owner: scholarship_user
--
...
ALTER TABLE public.scheduled_emails OWNER TO scholarship_user;

--
-- Name: scheduled_emails_id_seq; Type: SEQUENCE; Schema: public; Owner: scholarship_user
--
...
ALTER TABLE public.scheduled_emails_id_seq OWNER TO scholarship_user;

--
-- Name: scheduled_emails_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: scholarship_user
--
...
--
-- Name: email_history id; Type: DEFAULT; Schema: public; Owner: scholarship_user
--
...
--
-- Name: payment_roster_items id; Type: DEFAULT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.payment_roster_items ALTER COLUMN id SET DEFAULT nextval('public.payment_roster_items_id_seq'::regclass);


--
-- Name: payment_rosters id; Type: DEFAULT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.payment_rosters ALTER COLUMN id SET DEFAULT nextval('public.payment_rosters_id_seq'::regclass);
...
--
-- Name: roster_audit_logs id; Type: DEFAULT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.roster_audit_logs ALTER COLUMN id SET DEFAULT nextval('public.roster_audit_logs_id_seq'::regclass);


--
-- Name: roster_schedules id; Type: DEFAULT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.roster_schedules ALTER COLUMN id SET DEFAULT nextval('public.roster_schedules_id_seq'::regclass);


--
-- Name: scheduled_emails id; Type: DEFAULT; Schema: public; Owner: scholarship_user
--
...
--
-- Name: email_history email_history_pkey; Type: CONSTRAINT; Schema: public; Owner: scholarship_user
--
...
--
-- Name: payment_roster_items payment_roster_items_pkey; Type: CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.payment_roster_items
    ADD CONSTRAINT payment_roster_items_pkey PRIMARY KEY (id);


--
-- Name: payment_rosters payment_rosters_pkey; Type: CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.payment_rosters
    ADD CONSTRAINT payment_rosters_pkey PRIMARY KEY (id);


--
-- Name: payment_rosters payment_rosters_roster_code_key; Type: CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.payment_rosters
    ADD CONSTRAINT payment_rosters_roster_code_key UNIQUE (roster_code);
...
--
-- Name: roster_audit_logs roster_audit_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.roster_audit_logs
    ADD CONSTRAINT roster_audit_logs_pkey PRIMARY KEY (id);


--
-- Name: roster_schedules roster_schedules_pkey; Type: CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.roster_schedules
    ADD CONSTRAINT roster_schedules_pkey PRIMARY KEY (id);


--
-- Name: scheduled_emails scheduled_emails_pkey; Type: CONSTRAINT; Schema: public; Owner: scholarship_user
--
...
--
-- Name: payment_rosters uq_roster_scholarship_period; Type: CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.payment_rosters
    ADD CONSTRAINT uq_roster_scholarship_period UNIQUE (scholarship_configuration_id, period_label);
...
--
-- Name: idx_email_history_category_date; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX idx_email_history_category_date ON public.email_history USING btree (email_category, sent_at);


--
-- Name: idx_email_history_recipient_date; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX idx_email_history_recipient_date ON public.email_history USING btree (recipient_email, sent_at);


--
-- Name: idx_email_history_scholarship_date; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX idx_email_history_scholarship_date ON public.email_history USING btree (scholarship_type_id, sent_at);


--
-- Name: idx_email_history_status_date; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX idx_email_history_status_date ON public.email_history USING btree (status, sent_at);
...
--
-- Name: idx_scheduled_email_approval; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX idx_scheduled_email_approval ON public.scheduled_emails USING btree (requires_approval, approved_by_user_id);


--
-- Name: idx_scheduled_email_due; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX idx_scheduled_email_due ON public.scheduled_emails USING btree (scheduled_for, status);


--
-- Name: idx_scheduled_email_priority; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX idx_scheduled_email_priority ON public.scheduled_emails USING btree (priority, scheduled_for);


--
-- Name: idx_scheduled_email_scholarship; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX idx_scheduled_email_scholarship ON public.scheduled_emails USING btree (scholarship_type_id, status);
...
--
-- Name: ix_email_history_application_id; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_email_history_application_id ON public.email_history USING btree (application_id);


--
-- Name: ix_email_history_email_category; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_email_history_email_category ON public.email_history USING btree (email_category);


--
-- Name: ix_email_history_id; Type: INDEX; Schema: public; Owner: scholarship_user
--
...
--
-- Name: ix_email_history_recipient_email; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_email_history_recipient_email ON public.email_history USING btree (recipient_email);


--
-- Name: ix_email_history_scholarship_type_id; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_email_history_scholarship_type_id ON public.email_history USING btree (scholarship_type_id);


--
-- Name: ix_email_history_sent_at; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_email_history_sent_at ON public.email_history USING btree (sent_at);


--
-- Name: ix_email_history_status; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_email_history_status ON public.email_history USING btree (status);
...
--
-- Name: ix_payment_roster_items_application_id; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_payment_roster_items_application_id ON public.payment_roster_items USING btree (application_id);


--
-- Name: ix_payment_roster_items_id; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_payment_roster_items_id ON public.payment_roster_items USING btree (id);


--
-- Name: ix_payment_roster_items_roster_id; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_payment_roster_items_roster_id ON public.payment_roster_items USING btree (roster_id);


--
-- Name: ix_payment_rosters_id; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_payment_rosters_id ON public.payment_rosters USING btree (id);


--
-- Name: ix_payment_rosters_period_label; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_payment_rosters_period_label ON public.payment_rosters USING btree (period_label);


--
-- Name: ix_payment_rosters_roster_code; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_payment_rosters_roster_code ON public.payment_rosters USING btree (roster_code);
...
--
-- Name: ix_roster_audit_logs_created_at; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_roster_audit_logs_created_at ON public.roster_audit_logs USING btree (created_at);


--
-- Name: ix_roster_audit_logs_id; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_roster_audit_logs_id ON public.roster_audit_logs USING btree (id);


--
-- Name: ix_roster_audit_logs_roster_id; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_roster_audit_logs_roster_id ON public.roster_audit_logs USING btree (roster_id);


--
-- Name: ix_roster_schedules_id; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_roster_schedules_id ON public.roster_schedules USING btree (id);


--
-- Name: ix_scheduled_emails_application_id; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_scheduled_emails_application_id ON public.scheduled_emails USING btree (application_id);


--
-- Name: ix_scheduled_emails_id; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_scheduled_emails_id ON public.scheduled_emails USING btree (id);


--
-- Name: ix_scheduled_emails_recipient_email; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_scheduled_emails_recipient_email ON public.scheduled_emails USING btree (recipient_email);


--
-- Name: ix_scheduled_emails_scheduled_for; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_scheduled_emails_scheduled_for ON public.scheduled_emails USING btree (scheduled_for);


--
-- Name: ix_scheduled_emails_scholarship_type_id; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_scheduled_emails_scholarship_type_id ON public.scheduled_emails USING btree (scholarship_type_id);


--
-- Name: ix_scheduled_emails_status; Type: INDEX; Schema: public; Owner: scholarship_user
--

CREATE INDEX ix_scheduled_emails_status ON public.scheduled_emails USING btree (status);
...
--
-- Name: email_history email_history_application_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.email_history
    ADD CONSTRAINT email_history_application_id_fkey FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: email_history email_history_scholarship_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.email_history
    ADD CONSTRAINT email_history_scholarship_type_id_fkey FOREIGN KEY (scholarship_type_id) REFERENCES public.scholarship_types(id);


--
-- Name: email_history email_history_sent_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.email_history
    ADD CONSTRAINT email_history_sent_by_user_id_fkey FOREIGN KEY (sent_by_user_id) REFERENCES public.users(id);


--
-- Name: email_history email_history_template_key_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.email_history
    ADD CONSTRAINT email_history_template_key_fkey FOREIGN KEY (template_key) REFERENCES public.email_templates(key);
...
--
-- Name: payment_roster_items payment_roster_items_application_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.payment_roster_items
    ADD CONSTRAINT payment_roster_items_application_id_fkey FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: payment_roster_items payment_roster_items_roster_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.payment_roster_items
    ADD CONSTRAINT payment_roster_items_roster_id_fkey FOREIGN KEY (roster_id) REFERENCES public.payment_rosters(id);


--
-- Name: payment_rosters payment_rosters_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.payment_rosters
    ADD CONSTRAINT payment_rosters_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);


--
-- Name: payment_rosters payment_rosters_locked_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.payment_rosters
    ADD CONSTRAINT payment_rosters_locked_by_fkey FOREIGN KEY (locked_by) REFERENCES public.users(id);


--
-- Name: payment_rosters payment_rosters_scholarship_configuration_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.payment_rosters
    ADD CONSTRAINT payment_rosters_scholarship_configuration_id_fkey FOREIGN KEY (scholarship_configuration_id) REFERENCES public.scholarship_configurations(id);
...
--
-- Name: roster_audit_logs roster_audit_logs_roster_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.roster_audit_logs
    ADD CONSTRAINT roster_audit_logs_roster_id_fkey FOREIGN KEY (roster_id) REFERENCES public.payment_rosters(id);


--
-- Name: roster_audit_logs roster_audit_logs_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.roster_audit_logs
    ADD CONSTRAINT roster_audit_logs_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);


--
-- Name: roster_schedules roster_schedules_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.roster_schedules
    ADD CONSTRAINT roster_schedules_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);


--
-- Name: roster_schedules roster_schedules_last_run_roster_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.roster_schedules
    ADD CONSTRAINT roster_schedules_last_run_roster_id_fkey FOREIGN KEY (last_run_roster_id) REFERENCES public.payment_rosters(id);


--
-- Name: roster_schedules roster_schedules_scholarship_configuration_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.roster_schedules
    ADD CONSTRAINT roster_schedules_scholarship_configuration_id_fkey FOREIGN KEY (scholarship_configuration_id) REFERENCES public.scholarship_configurations(id);


--
-- Name: scheduled_emails scheduled_emails_application_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.scheduled_emails
    ADD CONSTRAINT scheduled_emails_application_id_fkey FOREIGN KEY (application_id) REFERENCES public.applications(id);


--
-- Name: scheduled_emails scheduled_emails_approved_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.scheduled_emails
    ADD CONSTRAINT scheduled_emails_approved_by_user_id_fkey FOREIGN KEY (approved_by_user_id) REFERENCES public.users(id);


--
-- Name: scheduled_emails scheduled_emails_created_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.scheduled_emails
    ADD CONSTRAINT scheduled_emails_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id);


--
-- Name: scheduled_emails scheduled_emails_scholarship_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.scheduled_emails
    ADD CONSTRAINT scheduled_emails_scholarship_type_id_fkey FOREIGN KEY (scholarship_type_id) REFERENCES public.scholarship_types(id);


--
-- Name: scheduled_emails scheduled_emails_template_key_fkey; Type: FK CONSTRAINT; Schema: public; Owner: scholarship_user
--

ALTER TABLE ONLY public.scheduled_emails
    ADD CONSTRAINT scheduled_emails_template_key_fkey FOREIGN KEY (template_key) REFERENCES public.email_templates(key);
