...
def upgrade() -> None:
    ...
    op.add_column('email_templates', sa.Column('sending_type', sending_type_enum, nullable=False, server_default='single'))
    op.add_column('email_templates', sa.Column('recipient_options', postgresql.JSON(), nullable=True))
    op.add_column('email_templates', sa.Column('requires_approval', sa.Boolean(), nullable=False, server_default='false'))
    op.add_column('email_templates', sa.Column('max_recipients', sa.Integer(), nullable=True))
