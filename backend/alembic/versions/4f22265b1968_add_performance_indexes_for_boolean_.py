...
def upgrade() -> None:
    ...
    op.create_index(
        ...
        'scholarship_rules',
        ['is_initial_enabled'],
        postgresql_where=sa.text('is_initial_enabled = true')  # Partial index for true values only
    )
    ...
    op.create_index(
        ...
        'scholarship_rules',
        ['is_renewal_enabled'],
        postgresql_where=sa.text('is_renewal_enabled = true')  # Partial index for true values only
    )
...
def downgrade() -> None:
    ...
    op.drop_index('idx_scholarship_rules_academic_period', table_name='scholarship_rules')
    op.drop_index('idx_scholarship_rules_type_renewal_enabled', table_name='scholarship_rules')
    op.drop_index('idx_scholarship_rules_type_initial_enabled', table_name='scholarship_rules')
    op.drop_index('idx_scholarship_rules_is_renewal_enabled', table_name='scholarship_rules')
    op.drop_index('idx_scholarship_rules_is_initial_enabled', table_name='scholarship_rules')