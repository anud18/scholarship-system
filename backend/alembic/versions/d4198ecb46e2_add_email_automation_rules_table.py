...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['template_key'], ['email_templates.key'], ondelete='CASCADE'),
    )
    
    # Create indexes for performance
    op.create_index('idx_automation_rules_trigger', 'email_automation_rules', ['trigger_event', 'is_active'])
    op.create_index('idx_automation_rules_template', 'email_automation_rules', ['template_key'])
