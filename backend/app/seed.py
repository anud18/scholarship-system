...
async def seed_development():
    ...
    async with AsyncSessionLocal() as session:
        ...
        try:
            ...
            print("- 114 得獎者 (115 續領候選, 姓名前綴「續領-」): 313551201 / 313551202 / 312551203 / 313551204 / 311551205")
            print("- 115 新申請 (學生自行申請, 姓名前綴「新申請-」): 315551401 / 314551402 / 315551403 / 314551404")
            print("- 115 批次匯入 (Excel, 不預建帳號, 姓名前綴「匯入-」): 314551301 / 314551302 / 314551303 / 313551304")
