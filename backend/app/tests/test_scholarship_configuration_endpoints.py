...
class TestScholarshipConfigurationEndpoints:
    ...
    async def test_list_configurations_with_filters(
        ...
        configs_data = [
            {
                "academic_year": 113, "semester": "first", 
                "code": "LIST-113-1", "name": "List Test 113-1"
            },
            {
                "academic_year": 113, "semester": "second", 
                "code": "LIST-113-2", "name": "List Test 113-2"
            },
            {
                "academic_year": 114, "semester": "first", 
                "code": "LIST-114-1", "name": "List Test 114-1"
            }
        ]
...
class TestScholarshipConfigurationEndpointsIntegration:
    ...
    async def test_complete_configuration_workflow(
        ...
        update_payload = {
            "config_name": "Updated via Workflow",
            "amount": 55000
        }
