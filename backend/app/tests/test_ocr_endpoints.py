...
class TestOCREndpoints:
    ...
    def test_bank_passbook_ocr_success(self, mock_get_ocr_service, mock_get_current_user, client, sample_image_file, mock_current_user):
        """Test successful bank passbook OCR"""
        mock_get_current_user.return_value = mock_current_user

        # Mock OCR service
        mock_ocr_service = MagicMock()
        mock_ocr_service.extract_bank_info_from_image = AsyncMock(return_value={
            "success": True,
            "bank_name": "台灣銀行",
            "bank_code": "004",
    ...
    @patch('app.api.v1.endpoints.user_profiles.get_current_user')
    @patch('app.api.v1.endpoints.user_profiles.get_ocr_service')
    def test_bank_passbook_ocr_low_confidence(self, mock_get_ocr_service, mock_get_current_user, client, sample_image_file, mock_current_user):
    ...
    @patch('app.api.v1.endpoints.user_profiles.get_current_user')
    @patch('app.api.v1.endpoints.user_profiles.get_ocr_service')
    def test_bank_passbook_ocr_failure(self, mock_get_ocr_service, mock_get_current_user, client, sample_image_file, mock_current_user):
    ...
    @patch('app.api.v1.endpoints.user_profiles.get_current_user')
    @patch('app.api.v1.endpoints.user_profiles.get_ocr_service')
    def test_bank_passbook_ocr_service_unavailable(self, mock_get_ocr_service, mock_get_current_user, client, sample_image_file, mock_current_user):
    ...
    @patch('app.api.v1.endpoints.user_profiles.get_current_user')
    @patch('app.api.v1.endpoints.user_profiles.get_ocr_service')
    def test_bank_passbook_ocr_processing_error(self, mock_get_ocr_service, mock_get_current_user, client, sample_image_file, mock_current_user):
    ...
    @patch('app.api.v1.endpoints.user_profiles.get_current_user')
    @patch('app.api.v1.endpoints.user_profiles.get_ocr_service')
    def test_document_ocr_success(self, mock_get_ocr_service, mock_get_current_user, client, sample_image_file, mock_current_user):
        """Test successful document OCR"""
        mock_get_current_user.return_value = mock_current_user

        # Mock OCR service
        mock_ocr_service = MagicMock()
        mock_ocr_service.extract_general_text_from_image = AsyncMock(return_value={
            "success": True,
    ...
    @patch('app.api.v1.endpoints.user_profiles.get_current_user')
    @patch('app.api.v1.endpoints.user_profiles.get_ocr_service')
    def test_document_ocr_failure(self, mock_get_ocr_service, mock_get_current_user, client, sample_image_file, mock_current_user):
    ...
    @patch('app.api.v1.endpoints.user_profiles.get_current_user')
    @patch('app.api.v1.endpoints.user_profiles.get_ocr_service')
    def test_document_ocr_unexpected_error(self, mock_get_ocr_service, mock_get_current_user, client, sample_image_file, mock_current_user):
