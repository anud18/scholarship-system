...
class ScholarshipService:
    ...
    async def get_eligible_scholarships(self, student_data: Dict[str, Any], user_id: Optional[int] = None) -> List[Dict[str, Any]]:
        ...
        for config in active_configs:
                    ...
                    if student_code:
                        try:
                            ...
                            if term_data:
                                ...
                                logger.warning(f"Could not fetch term data for student {student_code}, AY{academic_year_str}, semester {semester_str}")
            ...
            is_eligible, reasons, eligibility_details = await eligibility_service.get_detailed_eligibility_check(
            ...
            if is_eligible:
                ...
                eligible_subtypes, subtype_eligibility_info = await self._filter_eligible_subtypes(
                    scholarship_type.sub_type_list or [], eligibility_details, scholarship_type
                )
    ...
    async def _filter_eligible_subtypes(self, all_subtypes: List[str], eligibility_details: Dict[str, Any], scholarship_type) -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
        """
