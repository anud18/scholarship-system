...
Index('ix_college_reviews_application_reviewer', CollegeReview.application_id, CollegeReview.reviewer_id)
Index('ix_college_reviews_ranking_score', CollegeReview.ranking_score.desc())  # For ranking queries
Index('ix_college_reviews_recommendation_status', CollegeReview.recommendation, CollegeReview.review_status)
Index('ix_college_reviews_priority_attention', CollegeReview.is_priority, CollegeReview.needs_special_attention)

# Index for ranking queries
Index('ix_college_rankings_lookup', CollegeRanking.scholarship_type_id, CollegeRanking.sub_type_code, 
      CollegeRanking.academic_year, CollegeRanking.semester)
Index('ix_college_rankings_status_finalized', CollegeRanking.ranking_status, CollegeRanking.is_finalized)

# Index for ranking items
Index('ix_college_ranking_items_position', CollegeRankingItem.ranking_id, CollegeRankingItem.rank_position)
Index('ix_college_ranking_items_allocation', CollegeRankingItem.is_allocated, CollegeRankingItem.status)
Index('ix_college_ranking_items_score', CollegeRankingItem.total_score.desc())

# Index for quota distribution tracking
Index('ix_quota_distributions_academic_year', QuotaDistribution.academic_year, QuotaDistribution.semester)
Index('ix_quota_distributions_execution', QuotaDistribution.executed_at, QuotaDistribution.executed_by)