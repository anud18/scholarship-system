...
class ApplicationSequence(Base):
    ...
    semester = Column(String(20), primary_key=True, nullable=False, comment="學期：first, second, annual")
    ...
    def get_semester_code(semester: str) -> str:
        ...
        Returns:
            str: '1' for first, '2' for second, '0' for annual
        """
        semester_map = {
            "first": "1",
            "second": "2",
    ...
    def format_app_id(academic_year: int, semester: str, sequence: int) -> str:
        ...
        Args:
            ...
            semester: Semester enum value ('first', 'second', 'annual')
