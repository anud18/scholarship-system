...
from sqlalchemy import Column, Integer, String, Boolean, DateTime, ForeignKey, Text, JSON, UniqueConstraint, Index, Enum
...
class Notification(Base):
    ...
    notification_type = Column(Enum(NotificationType), default=NotificationType.INFO, nullable=False, index=True)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            "id": self.id,
            "type": self.notification_type.value if isinstance(self.notification_type, NotificationType) else self.notification_type,
            "title": self.title,
...
class NotificationPreference(Base):
    ...
    # Frequency control
    frequency = Column(Enum(NotificationFrequency), default=NotificationFrequency.IMMEDIATE, nullable=False)
...
class NotificationTemplate(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    type = Column(Enum(NotificationType), unique=True, nullable=False)
