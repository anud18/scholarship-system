...
api_router.include_router(
    quota_dashboard.router, prefix="/quota-dashboard", tags=["Quota Dashboard"]
)
...
api_router.include_router(
    application_fields.router, prefix="/application-fields", tags=["Application Fields"]
)
api_router.include_router(
...
api_router.include_router(
    scholarship_rules.router, prefix="/scholarship-rules", tags=["Scholarship Rules"]
)
api_router.include_router(
    professor.router, prefix="/professor", tags=["Professor Review"]
)
api_router.include_router(
    college_review.router, prefix="/college", tags=["College Review"]
)
api_router.include_router(
    email_management.router, prefix="/email-management", tags=["Email Management"]
)
