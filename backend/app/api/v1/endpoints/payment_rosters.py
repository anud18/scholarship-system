...
def generate_payment_roster(
    ...
    try:
        ...
        # 產生造冊（返回 Dict 格式）
        result = roster_service.generate_roster(
        ...
        return {
            ...
            "message": message,
            "data": {
                "roster": response_data.model_dump() if hasattr(response_data, "model_dump") else response_data.dict(),
                "warnings": warnings,
