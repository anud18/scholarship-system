...
async def copy_rules(
    ...
    for source_rule in source_rules:
        ...
        if existing_rule and copy_request.overwrite_existing:
            ...
            for field in ['condition_field', 'operator', 'expected_value', 'message', 
                         'message_en', 'is_hard_rule', 'is_warning', 'priority', 
                         'description', 'tag', 'is_initial_enabled', 'is_renewal_enabled']:
...
@router.get("/scholarship-types/{scholarship_type_id}/sub-types", response_model=ApiResponse[List[Dict[str, Any]]])
