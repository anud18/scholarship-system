...
RENEWAL_ROWS = [
    ("C", "資訊學院", "資訊工程學系", "林承翰", "313551201", "博三", "是", "通過", "國科會"),
    ("C", "資訊學院", "資訊科學與工程研究所", "張雅婷", "313551202", "博三", "是", "通過", "教育部"),
    ("E", "電機學院", "電機工程學系", "黃冠宇", "312551203", "博四", "是", "通過", "國科會"),
    ("E", "電機學院", "電機學院博士班", "吳佩珊", "313551204", "博三", "是", "通過", "教育部"),
    ("C", "資訊學院", "資訊工程學系", "鄭宇軒", "311551205", "博五", "否", "領獎期滿，無續領", "國科會"),
]
...
BATCH_ROWS = [
    ("314551301", "陳柏宇", "C", 1, 1, "國立陽明交通大學資訊學院資訊工程學系"),
    ("314551302", "李欣怡", "C", 0, 1, "國立臺灣大學電機資訊學院資訊工程學系"),
    ("314551303", "王志豪", "E", 1, 0, "國立清華大學電機資訊學院電機工程學系"),
    ("313551304", "劉育綺", "E", 1, 1, "國立成功大學電機資訊學院電機工程學系"),
]
