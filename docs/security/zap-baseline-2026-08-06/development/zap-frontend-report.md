...
| Low | Warning |  | ZAP warnings logged - see the zap.log file for details | 26    |
...
| Info | Informational | http://localhost:3000 | Percentage of endpoints with content type application/javascript | 63 % |
| Info | Informational | http://localhost:3000 | Percentage of endpoints with content type application/json | 22 % |
...
| Info | Informational | http://localhost:3000 | Percentage of endpoints with content type text/html | 3 % |
...
| Info | Informational | http://localhost:3000 | Percentage of endpoints with method POST | 3 % |
| Info | Informational | http://localhost:3000 | Count of total endpoints | 76    |
...
| Information Disclosure - Suspicious Comments | Informational | 36 |
...
* URL: http://localhost:3000/_next/static/chunks/components_batch-import-panel_tsx_19db43a9._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/components_batch-import-panel_tsx_19db43a9._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `_uploadedBatch_validation_summary1`
  * Other Info: `��e��^t�r�jX�jب��.�f��`
...
* URL: http://localhost:3000/_next/static/chunks/node_modules_0749d7b1._.js
  ...
  * Parameter: ``
  * Attack: ``
  * Evidence: `/node_modules/zod/v3/helpers/parseUtil`
  * Other Info: `�z{��v�^���w������������-�`
...
* URL: http://localhost:3000/_next/static/chunks/node_modules_next_dist_client_cf1d9188._.js
  ...
  * Parameter: ``
  * Attack: ``
  * Evidence: `com/webpack/webpack/blob/3aa6b6bc3a64/lib/hmr/HotModuleReplacement`
  * Other Info: `r�����i�?���i�?nZ�v�龛sv���bo�f�����W�z�Zq鞞`
* URL: http://localhost:3000/_next/static/chunks/turbopack-_cdba956c._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/turbopack-_cdba956c._.js`
  * Method: `GET`
  * Parameter: ``
...
* URL: http://localhost:3000/_next/static/chunks/_6592d88f._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/_6592d88f._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: ` {
   ...
   *   `
  * Other Info: `The following pattern was used: \bUSERNAME\b and was detected 3 times, the first in likely comment: "/**
   * Get the raw typed client for direct API calls
   *
   * Usage:
   *   const response = await typedClient.raw.GET('/auth", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:3000/_next/static/chunks/_6592d88f._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/_6592d88f._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `/**
   * Log debug messages (developme`
  * Other Info: `The following pattern was used: \bDEBUG\b and was detected 2 times, the first in likely comment: "/**
...
* URL: http://localhost:3000/_next/static/chunks/_6592d88f._.js
  ...
  * Parameter: ``
  * Attack: ``
  * Evidence: `// Handle query parameters`
  * Other Info: `The following pattern was used: \bQUERY\b and was detected 61 times, the first in likely comment: "// Handle query parameters", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:3000/_next/static/chunks/_6592d88f._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/_6592d88f._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `// TODO: Update OpenAPI sch`
  * Other Info: `The following pattern was used: \bTODO\b and was detected in likely comment: "// TODO: Update OpenAPI schema for registration endpoint — until then,", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:3000/_next/static/chunks/_6592d88f._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/_6592d88f._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `;
 *   logger.info('User logged in', { userI`
  * Other Info: `The following pattern was used: \bUSER\b and was detected 29 times, the first in likely comment: "/**
 * Centralized logging utility with environment-aware behavior
 *
 * SECURITY: In production, logs generic messages only to ", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:3000/_next/static/chunks/_6592d88f._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/_6592d88f._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `content-type header from a fetch Response, t`
  * Other Info: `The following pattern was used: \bFROM\b and was detected 76 times, the first in likely comment: "/**
   * Extract the content-type header from a fetch Response, tolerating test
   * mocks that pass a plain-object `headers` ma", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:3000/_next/static/chunks/_6592d88f._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/_6592d88f._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `d / session restore where the token only live`
 ...
 *
 * The typed client keeps an in-memory copy, but that can be em", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:3000/_next/static/chunks/_6592d88f._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/_6592d88f._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `er CRUD operations (admin)
 * - User statisti`
  * Other Info: `The following pattern was used: \bADMIN\b and was detected 46 times, the first in likely comment: "/**
 * Users API Module (OpenAPI-typed)
 *
 * Handles user-related operations including:
 * - Profile management
 * - Student in", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:3000/_next/static/chunks/_6592d88f._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/_6592d88f._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `g primitive:
 *     Select, DropdownMenu, Dial`
 ...
 *
 * With production `style-src` nonce-gated (no 'unsaf", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:3000/_next/static/chunks/_6592d88f._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/_6592d88f._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `hose allocation was later revoked or suspende`
  * Other Info: `The following pattern was used: \bLATER\b and was detected in likely comment: "/**
     * 取得造冊中已撤銷/停發的學生清單
     * Lists students still embedded in a locked roster whose allocation was later revoked or suspen", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:3000/_next/static/chunks/components_enhanced-student-portal_tsx_ac266d54._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/components_enhanced-student-portal_tsx_ac266d54._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `// Debug authentication stat`
  * Other Info: `The following pattern was used: \bDEBUG\b and was detected 5 times, the first in likely comment: "// Debug authentication status", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:3000/_next/static/chunks/components_enhanced-student-portal_tsx_ac266d54._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/components_enhanced-student-portal_tsx_ac266d54._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `editing application from the applications li`
  * Other Info: `The following pattern was used: \bFROM\b and was detected 3 times, the first in likely comment: "// Get the editing application from the applications list", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:3000/_next/static/chunks/components_user-permission-management_tsx_eb418631._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/components_user-permission-management_tsx_eb418631._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `// User management states`
  * Other Info: `The following pattern was used: \bUSER\b and was detected 3 times, the first in likely comment: "// User management states", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:3000/_next/static/chunks/components_user-permission-management_tsx_eb418631._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/components_user-permission-management_tsx_eb418631._.js`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `ons for non-college/admin roles`
  * Other Info: `The following pattern was used: \bADMIN\b and was detected in likely comment: "// Remove all permissions for non-college/admin roles", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:3000/_next/static/chunks/node_modules_next_dist_b0daae9a._.js
  * Node Name: `http://localhost:3000/_next/static/chunks/node_modules_next_dist_b0daae9a._.js`
  * Method: `GET`
  * Parameter: ``
