...
| Cross Site Scripting Weakness (Persistent in JSON Response) | Low | 10 |
...
* URL: http://localhost:8100/api/v1/auth/dev-profiles/ZAP%2525x%2525x%2525x%2525x%2525x%2525x%2525x%2525x%2525x%2525x%250A/quick-setup
...
* URL: http://localhost:8100/api/v1/admin/announcements%3Fpage=1&size=20&notification_type=&priority=
  ...
  * Evidence: ``
  * Other Info: `Raised with LOW confidence as the Content-Type is not HTML.`
* URL: http://localhost:8100/api/v1/admin/system-announcements%3Flimit=5
  * Node Name: `http://localhost:8100/api/v1/admin/system-announcements (limit)`
  * Method: `GET`
  * Parameter: `message_en`
  * Attack: `<script>alert(1);</script>`
  * Evidence: ``
