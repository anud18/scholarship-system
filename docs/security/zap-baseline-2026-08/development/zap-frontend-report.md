...
| Info | Informational | http://localhost:3000 | Percentage of slow responses | 29 % |
...
* URL: http://localhost:3000/_next/static/chunks/_e084681a._.css
  ...
  * Other Info: `This issue still applies to error type pages (401, 403, 500, etc.) as those pages are often still affected by injection issues, in which case there is still concern for browsers sniffing pages away from their actual content type.
At "High" threshold this scan rule will not alert on client or server error responses.`
* URL: http://localhost:3000/_next/static/chunks/node_modules_react-pdf_dist_esm_Page_b26c4e20._.css
  * Node Name: `http://localhost:3000/_next/static/chunks/node_modules_react-pdf_dist_esm_Page_b26c4e20._.css`
  * Method: `GET`
  * Parameter: `x-content-type-options`
  * Attack: ``
  * Evidence: ``
